...
export interface FrameTemplate {
  ...
  renderFrameSvgString: (color: string, size?: number) => string
}
...
export const frameTemplates: FrameTemplate[] = [
  ...
  },
  {
    ...
    renderFrameSvgString: (color, size = 512) => 
      `<rect x="20" y="20" width="472" height="472" rx="8" stroke="${color}" stroke-width="8" fill="none"/>`
  },
  {
    id: 'double',
    name: 'ダブルボーダー',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="15" y="15" width="482" height="482" rx="8" stroke="${color}" stroke-width="6" fill="none"/>
       <rect x="30" y="30" width="452" height="452" rx="4" stroke="${color}" stroke-width="4" fill="none"/>`
  },
  {
    id: 'band-bottom',
    name: '下部バンド',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="20" y="20" width="472" height="472" rx="8" stroke="${color}" stroke-width="6" fill="none"/>
       <rect x="20" y="420" width="472" height="72" fill="${color}"/>`
  },
  {
    id: 'band-top',
    name: '上部バンド',
  ...
  },
  {
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="20" y="20" width="472" height="472" rx="8" stroke="${color}" stroke-width="6" stroke-dasharray="10,5" fill="none"/>
       <circle cx="20" cy="256" r="12" fill="white" stroke="${color}" stroke-width="4"/>
       <circle cx="492" cy="256" r="12" fill="white" stroke="${color}" stroke-width="4"/>`
  },
  {
    id: 'dotted',
    name: 'ドット',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="20" y="20" width="472" height="472" rx="8" stroke="${color}" stroke-width="6" stroke-dasharray="2,8" fill="none"/>`
  },
  {
    id: 'badge',
    name: 'バッジ',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="20" y="20" width="472" height="472" rx="12" stroke="${color}" stroke-width="8" fill="none"/>
       <circle cx="50" cy="50" r="20" fill="${color}"/>
       <circle cx="462" cy="50" r="20" fill="${color}"/>
       <circle cx="50" cy="462" r="20" fill="${color}"/>
       <circle cx="462" cy="462" r="20" fill="${color}"/>`
  ...
  },
  {
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<defs>
       ...
       <rect x="20" y="20" width="472" height="472" rx="12" stroke="${color}" stroke-width="6" fill="none" filter="url(#shadow-${size})"/>`
  },
  {
    id: 'glow',
    name: 'グロー',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<defs>
       ...
       <rect x="20" y="20" width="472" height="472" rx="12" stroke="${color}" stroke-width="8" fill="none" filter="url(#glow-${size})"/>`
  },
  {
    id: 'minimal',
    name: 'ミニマル',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="30" y="30" width="452" height="452" rx="4" stroke="${color}" stroke-width="2" fill="none"/>`
  },
  {
    id: 'rounded',
    name: 'ラウンド',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="20" y="20" width="472" height="472" rx="40" stroke="${color}" stroke-width="8" fill="none"/>`
  },
  {
    id: 'corners',
    name: 'コーナー',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<path d="M 20 60 L 20 20 L 60 20" stroke="${color}" stroke-width="8" fill="none" stroke-linecap="round"/>
       <path d="M 452 20 L 492 20 L 492 60" stroke="${color}" stroke-width="8" fill="none" stroke-linecap="round"/>
       <path d="M 60 492 L 20 492 L 20 452" stroke="${color}" stroke-width="8" fill="none" stroke-linecap="round"/>
       <path d="M 492 452 L 492 492 L 452 492" stroke="${color}" stroke-width="8" fill="none" stroke-linecap="round"/>`
  },
  {
    id: 'bubble',
    name: 'バブル',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="20" y="20" width="472" height="442" rx="20" stroke="${color}" stroke-width="8" fill="none"/>
       <path d="M 230 462 L 256 492 L 282 462" fill="${color}" stroke="${color}" stroke-width="4"/>`
  },
  {
    id: 'hexagon',
    name: '六角形',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<path d="M 256 20 L 456 136 L 456 376 L 256 492 L 56 376 L 56 136 Z" stroke="${color}" stroke-width="8" fill="none"/>`
  },
  {
    id: 'starburst',
    name: 'スターバースト',
    ...
    renderFrameSvgString: (color, size = 512) => {
      ...
      return `<rect x="40" y="40" width="432" height="432" rx="8" stroke="${color}" stroke-width="6" fill="none"/>${rays}`
    }
  },
  {
    id: 'envelope',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="20" y="20" width="472" height="472" rx="8" stroke="${color}" stroke-width="6" fill="none"/>
       <path d="M 40 40 L 256 220 L 472 40" stroke="${color}" stroke-width="4" fill="none"/>
       <path d="M 256 470 L 472 470 L 472 290 L 256 220 L 40 290 L 40 470 Z" fill="${color}" opacity="0.2"/>`
  },
  {
    id: 'smartphone',
    ...
    renderFrame: (color, size = 512) => (
      <svg width={size} height={size} viewBox="0 0 512 512" fill="none">
        <rect x="100" y="10" width="312" height="492" rx="24" stroke={color} strokeWidth="8" fill="none"/>
        <rect x="120" y="50" width="272" height="412" rx="4" stroke={color} strokeWidth="4" fill="none"/>
        <circle cx="256" cy="480" r="12" fill={color}/>
      </svg>
    ),
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="100" y="10" width="312" height="492" rx="24" stroke="${color}" stroke-width="8" fill="none"/>
       <rect x="120" y="50" width="272" height="412" rx="4" stroke="${color}" stroke-width="4" fill="none"/>
       <circle cx="256" cy="480" r="12" fill="${color}"/>`
  },
  {
    id: 'floral',
    ...
    renderFrameSvgString: (color, size = 512) =>
      `<rect x="30" y="30" width="452" height="452" rx="12" stroke="${color}" stroke-width="6" fill="none"/>
       <path d="M 30 30 Q 30 60, 50 70 Q 30 80, 30 110" stroke="${color}" stroke-width="3" fill="none"/>
       <path d="M 482 30 Q 482 60, 462 70 Q 482 80, 482 110" stroke="${color}" stroke-width="3" fill="none"/>
       <path d="M 30 482 Q 30 452, 50 442 Q 30 432, 30 402" stroke="${color}" stroke-width="3" fill="none"/>
       <path d="M 482 482 Q 482 452, 462 442 Q 482 432, 482 402" stroke="${color}" stroke-width="3" fill="none"/>`
  }
]
